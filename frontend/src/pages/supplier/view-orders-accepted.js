...
class ViewOrdersAccepted extends Component {
    constructor(props) {
        super(props);
    ...
    findOrderData(currentPage) {
        ...
        OrderService.getOrders(currentPage, this.state.rawDataPerPage, this.state.customerId, 'ORDER_DELIVERING', 'Supplier').then(response => response.data).then(data => {
            let numbers = [];
    ...
    orderDelivered(data) {
        OrderService.changeStatus(data.orderLinePK, "DELIVERED");
        window.location.reload();
    }
                                    ...
                                    return <tr>
                                        ...
                                        <td>
                                            <button className={'btn waves-effect waves-light order-view-button'}
                                                    onClick={() => this.orderDelivered(data)}>Order Delivered
                                            </button>
                                        </td>
                                    </tr>
                                })
...
export default withRouter(ViewOrdersAccepted)
