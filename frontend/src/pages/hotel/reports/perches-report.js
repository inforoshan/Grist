...
class PurchaseReport extends Component {
    ...
    findOrderData(startDate, endDate) {
        ...
        OrderService.getOrdersByDate(startDate, endDate, this.state.customerId, 'REFUND', 'Hotel').then(response => response.data).then(data => {
    ...
    // printDoc()
    // {
    //     var divTag = document.getElementById('print-page').innerHTML;
    //     var newWindow = window.open();
    //     newWindow.document.write('<html><body>');
    //     newWindow.document.write(divTag);
        ...
        return (
            <>
                ...
                <div className={'container'}>
                    <div className={'row '}>
                        <form>
                            <div className="col s4">
                                <label >From: </label>
                                <input type="datetime-local" id="start" name="trip-start" value={this.state.startDate}
                                       onChange={(e) => this.fromDate(e)}/>

                            </div>
                            <div className="col s4">
                                <label className={''}>To: </label>
                                <input type="datetime-local" id="start" name="trip-start" value={this.state.endDate}
                    ...
                    <div className={'raw_home'} id={'print-page'}>
